...
import com.library.listviewanimations.ListViewSetter;
import com.library.listviewanimations.util.AdapterViewUtil;

/**
 * An {@link com.library.listviewanimations.ArrayAdapter} which allows items to be expanded using an animation.
 */
...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> implements ListViewSetter {
    ...
    /**
     * Creates a new {@link com.library.listviewanimations.itemmanipulation.ExpandableListItemAdapter} with the specified list,
