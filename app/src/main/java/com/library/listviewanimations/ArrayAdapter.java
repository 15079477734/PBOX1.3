...
import com.library.listviewanimations.itemmanipulation.AnimateAdditionAdapter;
import com.library.listviewanimations.widget.DynamicListView;

/**
 * A {@code true} {@link java.util.ArrayList} adapter providing access to all ArrayList methods.
 * Also implements {@link com.library.listviewanimations.widget.DynamicListView.Swappable} for easy object swapping, and {@link com.library.listviewanimations.itemmanipulation.AnimateAdditionAdapter.Insertable} for inserting objects.
 */
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements List<T>, DynamicListView.Swappable, AnimateAdditionAdapter.Insertable<T> {
    ...
    /**
     * Creates a new {@link com.library.listviewanimations.ArrayAdapter} using given {@code List} , or an empty {@code List}  if objects == null.
     */
    ...
    /**
     * Creates a new {@link com.library.listviewanimations.ArrayAdapter}, using (a copy of) given {@code List} , or an empty {@code List}  if objects = null.
